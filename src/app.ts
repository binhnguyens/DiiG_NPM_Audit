...
app.get("/activityschedulenotifyxxx",async function(req,res){



const jobsee = await PushNotificationQueue.getJobs(['waiting','active','completed','failed','delayed'])
//    console.log("pushnotifyjobs",jobsee)

     for (const job of jobsee) {
console.log("jobid",job.id);
console.log("pushnotifydataaaaa",job.data) 
     }
res.json(true)
  })
